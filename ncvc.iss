[Setup]
OutputBaseFilename=ncvc415e_install
AppName=NCVC
AppVerName=NCVC Version 4.15e
AppVersion=4.15e
VersionInfoVersion=4.1.5.5
...
var
  VersionNo: String;
begin
  if RegQueryStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\WOW6432Node\Microsoft\VisualStudio\14.0\VC\Runtimes\x86', 'Version', VersionNo) then begin
